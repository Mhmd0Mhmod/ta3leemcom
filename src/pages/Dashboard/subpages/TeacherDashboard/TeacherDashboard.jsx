                ...
                <AsideDashboard
                    ...
                    tabs={[
                        ...
                        {name: 'اضافة مجموعة', tab: 'addGroup', icon: Group},
                        {
                            ...
                            tab: 'addTest',
                            icon: TestIcon,
                            Details: <Details route="addTest" className={'gap-[18px]'} summary={'اضافة اختبار'}
                                              Icon={TestIcon} opend={opened}
                                              listItems={[{name: 'اونلاين'}, {name: 'اوفلاين'}]}
                                              tabName={['online', 'offline']} param={'test'}/>,
                        },
                        {
            ...
            <div className={'relative flex-grow self-stretch rounded bg-gray-100 p-10'}>
                ...
                {showScrollTop && (
                    <button onClick={scrollToTop}
                            className="absolute bottom-12 left-12 transition-all duration-300 hover:-translate-y-1">
                        <ScrollTop/>
                    </button>
                )}
            </div>
