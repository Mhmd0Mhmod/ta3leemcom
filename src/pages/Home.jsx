        ...
        <div className="  container mx-auto pt-1">
          <div className=" mx-auto my-12 text-center ">
            ...
            <div className="flex gap-32 justify-center">
              <button className="col-span-1 mb-44" onClick={ref?.onNextButtonClick} disabled={ref?.nextBtnDisabled}>
                <img src="Icons/arrow-white.svg" alt="arrow" />
              </button>
              <div className="w-[50%]">
                <Testimonial setRef={setRef} />
              </div>
              <button className="col-span-1 mb-44" onClick={ref?.onPrevButtonClick} disabled={ref?.prevBtnDisabled}>
