  ...
  <>
   <div className="relative">
    ...
    <div className="absolute left-0 top-16 -rotate-12">
     <img src="imgs/lamp.png" alt="lamp" className="w-24" />
    </div>
   </div>
   <div className="grid grid-cols-9 gap-12 items-center my-28">
    ...
    <div className="col-span-5 relative">
     <img
      src="imgs/video.jpeg"
      alt="vidoe"
      className="aspect-video rounded-[30px] brightness-75"
     />
     <span className="absolute inset-0 flex items-center justify-center">
      <CirclePlay color="white" strokeWidth={1} className="w-32 h-32" />
     </span>
