...
Modal.Window = function Window({ name, children }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 m-0 flex h-screen w-full items-center justify-center bg-[rgb(0,0,0,0.4)]">
      <div className="z-[999] flex h-[90vh] w-[90%] overflow-scroll rounded-xl border-2 bg-[white]">
        <div className="h-[100%]">
