...
function ProfileAndLogoutList({currentUser,logOut}) {
  ...
  return (
   <div className={'relative self-center'}>
     <Button className={'flex items-center gap-2 border-0 bg-transparent !text-[#605E5E]'}
     ...
     {openList && (
       <ul className={'absolute left-2 top-16 z-40 flex flex-col gap-4 rounded border bg-white p-2'}>
         ...
         <li
           className={'flex w-48 cursor-pointer items-center gap-4 rounded p-1 text-xl duration-300 hover:bg-[#B4D3E0]'}
