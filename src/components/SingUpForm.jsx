  ...
  return (
    <form className={"p-9 flex flex-col font-almaria"}>
      ...
      <div className={"flex justify-between"}>
        <FormInput type={"text"} name={"name"} placeholder={"الاسم الأول"} icon={profile} className={"w-[70px] "} />
        <FormInput type={"text"} name={"name"} placeholder={"الاسم الثاني"} className={"w-[70px]"} />
        <FormInput type={"text"} name={"name"} placeholder={"الاسم الثالث"} className={"w-[70px]"} />
      </div>
      <Heading as={"h4"} className={"text-secondary my-4"}>
        رقم الهاتف
      </Heading>
      <FormInput type={"Number"} name={"phone"} placeholder={"رقم الهاتف"} icon={phone} className={"w-full"} />
      <Heading as={"h4"} className={"text-secondary my-4"}>
        البريد الالكتروني
      </Heading>
      ...
      <Link className={"text-secondary underline text-accent-400"} to={"/login"}>
        لديك حساب بالفعل؟
      </Link>
    </form>
  );
