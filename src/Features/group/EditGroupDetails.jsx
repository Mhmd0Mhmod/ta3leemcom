    ...
    <>
      ...
      <div className="mb-40 mt-14 flex gap-40">
        <div>
          ...
          {levelNumber === '' ? <DropList title="اختر المرحلة الدراسية" options={[]} /> : <DropList title={'اختر المرحلة الدراسية'} options={userLevels[1].map((e) => e.name)} value={level} setValue={setLevel} optionsValue={userLevels[1].map((e) => e.levelId)} />}
        </div>
        <div>
